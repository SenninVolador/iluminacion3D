...
* ** Stationary (Estacionaria)**: Híbrida. La luz directa y sombras sobre personajes son dinámicas; los rebotes indirectos van horneados. Permite cambiar color e intensidad en runtime pero no mover su posición.
...
### Color Temperature (Temperatura de Color / Kelvin)
...
### FlattenNormal (Fuerza de Normales)
