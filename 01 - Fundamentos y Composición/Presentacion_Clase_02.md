...
# Presentación: Clase 02 — Taller 3-Point, Sol, Cielo y Movilidad
...
* ** Stationary (Estacionaria)**: Híbrida. Sombras dinámicas sobre personajes + rebotes horneados. Permite cambiar color/intensidad. *Límite de 4 luces solapadas (canales RGBA)*.
...
*  [Cyberpunk 2077 (RTX / Path Tracing Breakdown)](https://www.youtube.com/watch?v=a3YxH_xK004): 100% dinámico y trazado de rayos por la enorme densidad de neones emisivos y clima variable.
*  [Zelda: Tears of the Kingdom (Nintendo)](https://www.nintendo.com/games/detail/the-legend-of-zelda-tears-of-the-kingdom-switch/): Directional + Sky limpio con cel-shading y sombras en cascada optimizadas para Nintendo Switch.
