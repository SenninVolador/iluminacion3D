# Guía Rápida de Atajos de Teclado y Nodos (UE5)

Iluminación 3D · Docente Daniel Rojas (UNIACC)

Compendio técnico de combinaciones de teclas indispensables para agilizar la navegación en el Viewport 3D, el ajuste de luces y la creación rápida de nodos en el Material Graph.

---

## 1. Atajos Rápidos del Material Editor (Crear Nodos con 1 Click)

En lugar de hacer click derecho y buscar por nombre en la lista, mantén presionada la tecla indicada y haz un **click izquierdo** sobre el fondo del grafo:
...
* **Buscador general**: Presiona `Espacio` o haz `Click Derecho` en una zona vacía del editor para escribir el nombre de cualquier función matemática (ej: *FlattenNormal*, *Fresnel*, *Power*).
...
| :--- | :--- |
| **`Ctrl + L` + Mover Mouse** | Rotación interactiva de la **Directional Light** (Sol). Modifica la hora del día y la inclinación de sombras en tiempo real. |
| **`Click Derecho > Pilot`** (o `Ctrl + Shift + P`) | **Pilotar la luz**: Controlas la luz seleccionada como si fueras la cámara en primera persona. Fundamental para apuntar la **Key Light** o la **Rim Light** con máxima precisión. |
| **`G` (Game View)** | Oculta todos los gizmos, conos y flechas de luces para evaluar la escena limpia tal como la ve el jugador. |
...
| **`F11`** | Modo inmersivo en pantalla completa (oculta pestañas y menús). |
